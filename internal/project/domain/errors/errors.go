...
var (
	...
	ErrCPULimitExceeded          = errors.New("CPU limit must be between 500-8000 millicores (0.5-8 cores)")
	ErrMemoryRequestTooSmall     = errors.New("memory request must be at least 512Mi")
	ErrMemoryRequestExceedsLimit = errors.New("memory request cannot exceed memory limit")
	ErrMemoryLimitExceeded       = errors.New("memory limit must be between 512Mi-16384Mi (0.5GB-16GB)")
	ErrDiskLimitExceeded         = errors.New("disk limit must be between 1024Mi-3072Mi (1GB-3GB)")
	...
	ErrFreeResourcesFixed        = errors.New("free plan resources are fixed and cannot be modified (0.5 core, 1GB memory, 1GB disk)")
	ErrFreeTierResourceExceeded  = errors.New("free tier resource limit exceeded: beta period allows up to 1 core CPU, 2GB memory, 3GB disk")
	ErrFreePlanLimitExceeded     = errors.New("free plan is limited to 1 project per user")
)
