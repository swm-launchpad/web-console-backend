...
type Querier interface {
	...
	FindActiveBuildHistoriesByContainerID(ctx context.Context, containerID uint32) ([]FindActiveBuildHistoriesByContainerIDRow, error)
	...
	FindBuildHistoriesByContainerID(ctx context.Context, arg FindBuildHistoriesByContainerIDParams) ([]FindBuildHistoriesByContainerIDRow, error)
	FindBuildHistoryByID(ctx context.Context, buildHistoryID uint32) (FindBuildHistoryByIDRow, error)
	FindBuildHistoryByTektonPipelineRunName(ctx context.Context, tektonPipelineRunName sql.NullString) (FindBuildHistoryByTektonPipelineRunNameRow, error)
	...
	FindDeploymentsByProjectID(ctx context.Context, arg FindDeploymentsByProjectIDParams) ([]FindDeploymentsByProjectIDRow, error)
	FindLatestBuildHistoryByContainerID(ctx context.Context, containerID uint32) (FindLatestBuildHistoryByContainerIDRow, error)
	FindLatestDeploymentByProjectID(ctx context.Context, projectID uint32) (FindLatestDeploymentByProjectIDRow, error)
	...
	ListVolumes(ctx context.Context, arg ListVolumesParams) ([]ListVolumesRow, error)
