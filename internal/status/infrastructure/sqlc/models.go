...
type ServiceIncidentsSeverity string

const (
	ServiceIncidentsSeverityMinor    ServiceIncidentsSeverity = "minor"
	ServiceIncidentsSeverityMajor    ServiceIncidentsSeverity = "major"
	ServiceIncidentsSeverityCritical ServiceIncidentsSeverity = "critical"
)

func (e *ServiceIncidentsSeverity) Scan(src interface{}) error {
	switch s := src.(type) {
	case []byte:
		*e = ServiceIncidentsSeverity(s)
	case string:
		*e = ServiceIncidentsSeverity(s)
	default:
		return fmt.Errorf("unsupported scan type for ServiceIncidentsSeverity: %T", src)
	}
	return nil
}

type NullServiceIncidentsSeverity struct {
	ServiceIncidentsSeverity ServiceIncidentsSeverity `json:"service_incidents_severity"`
	Valid                    bool                     `json:"valid"` // Valid is true if ServiceIncidentsSeverity is not NULL
}

// Scan implements the Scanner interface.
func (ns *NullServiceIncidentsSeverity) Scan(value interface{}) error {
	if value == nil {
		ns.ServiceIncidentsSeverity, ns.Valid = "", false
		return nil
	}
	ns.Valid = true
	return ns.ServiceIncidentsSeverity.Scan(value)
}

// Value implements the driver Valuer interface.
func (ns NullServiceIncidentsSeverity) Value() (driver.Value, error) {
	if !ns.Valid {
		return nil, nil
	}
	return string(ns.ServiceIncidentsSeverity), nil
}

type ServiceIncidentsStatus string

const (
	ServiceIncidentsStatusInvestigating ServiceIncidentsStatus = "investigating"
	ServiceIncidentsStatusIdentified    ServiceIncidentsStatus = "identified"
	ServiceIncidentsStatusMonitoring    ServiceIncidentsStatus = "monitoring"
	ServiceIncidentsStatusResolved      ServiceIncidentsStatus = "resolved"
)

func (e *ServiceIncidentsStatus) Scan(src interface{}) error {
	switch s := src.(type) {
	case []byte:
		*e = ServiceIncidentsStatus(s)
	case string:
		*e = ServiceIncidentsStatus(s)
	default:
		return fmt.Errorf("unsupported scan type for ServiceIncidentsStatus: %T", src)
	}
	return nil
}

type NullServiceIncidentsStatus struct {
	ServiceIncidentsStatus ServiceIncidentsStatus `json:"service_incidents_status"`
	Valid                  bool                   `json:"valid"` // Valid is true if ServiceIncidentsStatus is not NULL
}

// Scan implements the Scanner interface.
func (ns *NullServiceIncidentsStatus) Scan(value interface{}) error {
	if value == nil {
		ns.ServiceIncidentsStatus, ns.Valid = "", false
		return nil
	}
	ns.Valid = true
	return ns.ServiceIncidentsStatus.Scan(value)
}

// Value implements the driver Valuer interface.
func (ns NullServiceIncidentsStatus) Value() (driver.Value, error) {
	if !ns.Valid {
		return nil, nil
	}
	return string(ns.ServiceIncidentsStatus), nil
}

type ServiceStatusChecksServiceCategory string

const (
	ServiceStatusChecksServiceCategoryCore           ServiceStatusChecksServiceCategory = "core"
	ServiceStatusChecksServiceCategoryBuildDeploy    ServiceStatusChecksServiceCategory = "build_deploy"
	ServiceStatusChecksServiceCategoryInfrastructure ServiceStatusChecksServiceCategory = "infrastructure"
)

func (e *ServiceStatusChecksServiceCategory) Scan(src interface{}) error {
	switch s := src.(type) {
	case []byte:
		*e = ServiceStatusChecksServiceCategory(s)
	case string:
		*e = ServiceStatusChecksServiceCategory(s)
	default:
		return fmt.Errorf("unsupported scan type for ServiceStatusChecksServiceCategory: %T", src)
	}
	return nil
}

type NullServiceStatusChecksServiceCategory struct {
	ServiceStatusChecksServiceCategory ServiceStatusChecksServiceCategory `json:"service_status_checks_service_category"`
	Valid                              bool                               `json:"valid"` // Valid is true if ServiceStatusChecksServiceCategory is not NULL
}

// Scan implements the Scanner interface.
func (ns *NullServiceStatusChecksServiceCategory) Scan(value interface{}) error {
	if value == nil {
		ns.ServiceStatusChecksServiceCategory, ns.Valid = "", false
		return nil
	}
	ns.Valid = true
	return ns.ServiceStatusChecksServiceCategory.Scan(value)
}

// Value implements the driver Valuer interface.
func (ns NullServiceStatusChecksServiceCategory) Value() (driver.Value, error) {
	if !ns.Valid {
		return nil, nil
	}
	return string(ns.ServiceStatusChecksServiceCategory), nil
}

type ServiceStatusChecksStatus string

const (
	ServiceStatusChecksStatusOperational ServiceStatusChecksStatus = "operational"
	ServiceStatusChecksStatusDegraded    ServiceStatusChecksStatus = "degraded"
	ServiceStatusChecksStatusDown        ServiceStatusChecksStatus = "down"
)

func (e *ServiceStatusChecksStatus) Scan(src interface{}) error {
	switch s := src.(type) {
	case []byte:
		*e = ServiceStatusChecksStatus(s)
	case string:
		*e = ServiceStatusChecksStatus(s)
	default:
		return fmt.Errorf("unsupported scan type for ServiceStatusChecksStatus: %T", src)
	}
	return nil
}

type NullServiceStatusChecksStatus struct {
	ServiceStatusChecksStatus ServiceStatusChecksStatus `json:"service_status_checks_status"`
	Valid                     bool                      `json:"valid"` // Valid is true if ServiceStatusChecksStatus is not NULL
}

// Scan implements the Scanner interface.
func (ns *NullServiceStatusChecksStatus) Scan(value interface{}) error {
	if value == nil {
		ns.ServiceStatusChecksStatus, ns.Valid = "", false
		return nil
	}
	ns.Valid = true
	return ns.ServiceStatusChecksStatus.Scan(value)
}

// Value implements the driver Valuer interface.
func (ns NullServiceStatusChecksStatus) Value() (driver.Value, error) {
	if !ns.Valid {
		return nil, nil
	}
	return string(ns.ServiceStatusChecksStatus), nil
}
...
// Incident and outage records (permanent retention)
...
// Individual health check results (30-day retention)
type ServiceStatusCheck struct {
	CheckID uint64 `json:"check_id"`
	// Service identifier (api_server, web_console, mysql, etc.)
	ServiceName     string                             `json:"service_name"`
	...
	// Error details if status is not operational
...
// Daily uptime statistics (permanent retention)
type ServiceUptimeDaily struct {
	UptimeID    uint64 `json:"uptime_id"`
	ServiceName string `json:"service_name"`
	// Date in UTC
