...
func InitializeApp() (*App, error) {
	...
	getDeploymentHistoryUseCase := application2.NewGetDeploymentHistoryUseCase(deploymentRepository, logger)
	deploymentHandler := handler2.NewDeploymentHandler(deployProjectUseCase, getDeploymentHistoryUseCase, permissionService, projectService, logger)
	...
	processWebhookUseCase := application3.NewProcessWebhookUseCase(containerRepository)
	webhookTokenService := service3.NewWebhookTokenService(containerRepository)
	enableWebhookUseCase := application3.NewEnableWebhookUseCase(containerRepository, webhookTokenService)
	disableWebhookUseCase := application3.NewDisableWebhookUseCase(containerRepository)
	regenerateWebhookTokenUseCase := application3.NewRegenerateWebhookTokenUseCase(containerRepository, webhookTokenService)
	webhookHandler := handler3.NewWebhookHandler(processWebhookUseCase, enableWebhookUseCase, disableWebhookUseCase, regenerateWebhookTokenUseCase, containerService, logger)
