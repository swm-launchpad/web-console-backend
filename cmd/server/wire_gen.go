...
func InitializeApp() (*App, error) {
	...
	refreshDeploymentUseCase := application2.NewRefreshDeploymentUseCase(deployService, deploymentRepository)
	deploymentHandler := handler2.NewDeploymentHandler(deployProjectUseCase, refreshDeploymentUseCase, permissionService)
